...
```{r cwrulogo1-fig, echo = FALSE, fig.align = "center", out.width = '30%'}
knitr::include_graphics("images/cwru_logo.jpg")
```

## Working with This Document {-}

1. This document includes multiple sections. Use the table of contents at left to navigate. 
...
- The course is given on Tuesdays and Thursdays from 1:00 to 2:15 PM Eastern Time, via Zoom, starting on 2020-08-25.
  - If you are registered for the course, the Zoom link for the first few classes will be made available to you via [Canvas](https://canvas.case.edu) and sent to your CWRU (and preferred) email on Monday 2020-08-24.
  - Each class is video-recorded, and the recordings are archived on [Canvas](https://canvas.case.edu).

## Main Course Web Site {-}

At the first class, we'll share the course website. This will include links to:
...
When you are able, please contact Dr. Love (via email) if you encounter any problem which will keep you from participating in the course for **more than two sessions in a row** to figure out what sort of accommodations will be needed. If you need to miss one session, or even two, just review the materials (including the recordings) and move on, and please feel encouraged to ask for help.

# Getting Started

## Before our First Class

Most of you have already accessed [the pre-class website](https://431-2020-preclass-love.netlify.app/). Once class begins, that will no longer be relevant, and will be replaced by our main course website and (among other things) this Syllabus. If you're seeing this before class starts on 2020-08-25, then make sure that you:
...
- Professor Love uses he/him/his pronouns, and identifies as male.
    - Most students refer to him either as Professor Love or Dr. Love, and I prefer this during class.
...
To get help from the TAs and Professor Love, visit the [Getting Help][Getting Help] section of this Syllabus. 
...
Visit the main course website for links to all materials.
...
3. Install some **R packages** - an R "package" is a collection of functions, data, and documentation that extends the capabilities of R, and is the critical way to get R doing interesting work. 
    - A list of [initial R Packages to install][Initial R Packages to Install] is provided below, along with instructions. A more complete list of packages will be maintained on the main course website.
...
During the semester, there are **ten** Minute Papers scheduled. In this class, a Minute Paper is a short survey (completed using a Google Form) where you will answer a few questions about how the course is going for you. To complete the Minute Paper, you'll need to log into Google with your CWRU account. The pre-class survey uses a similar format, but 

Each Minute Paper would ideally take less than five minutes to complete, right at the end of Tuesday's class, but is actually due at noon Wednesday most weeks to give you some time to reflect, if you'd like, or if you're in a hurry at the end of class.

Students who watch the class via video recording are still required and encouraged to complete the Minute Paper in a timely fashion. You should complete the Minute Paper even if you haven't yet viewed the most recent class.

### Grading Class Participation

Only Professor Love sees the results of the Minute Papers with identifying information. He then summarizes findings at the group level (and in terms of specific questions) and addresses those in the Thursday class whenever possible.

Student Class Participation grades are based on:

- 50 points, plus
- up to 50 additional points for Minute Paper responses (5 points for each on-time submission)
- plus a few bonus points for actions that help the class, as awarded during the semester

These bonus points have a small impact, generally, but include things like:

- finding typographical or coding errors in Professor Love's slides, notes and other materials.
...
1. If you're not shy, ask questions in the Chat during class. The TAs help me assess participation, so they are paying attention, too. Come to the TA office hours if you need help. Make an appointment to talk to us if you have something to discuss that doesn't work well in email. 
...
3. Email or chat with Professor Love about your questions/comments/concerns. Try to help him get to know who you are - which can be a real challenge with such a large group.
...
More information (and the actual Lab assignments) will be found on the Labs page of our main course web site.
...
- Lab submissions received after the answer sketch is published but still within one week can receive up to 80% of available points.
...
During the semester, you will have two quizzes to complete. Each quiz is taken online via a Google Form, and consists of a series of short-answer and multiple-choice items. The quizzes focus on whether you can apply the tools developed in class to address small problems. Each quiz is "open book, open notes"

You will typically receive access to the quiz 4 days before it is due, and each quiz will be designed to take 4-6 hours to complete, so the time pressure should be minimal. 
...
For more information on the Quizzes, please visit the Quizzes web page on our main course web site.

### Grading the Quizzes

Each quiz will be graded by Dr. Love. A detailed answer sketch and grading rubric will be provided to you when grades are available, usually within 48 hours of the quiz deadline. 
...
For more information on the Projects, please visit the Projects web page on our main course web site.
...
For students in the 85-88% range, in addition to the labs/projects/quizzes, I will consider improvement from the first half of the course to the second in addition to your overall grade to make a final determination.
...
Once you have read through this Syllabus, please e-mail Professor Love the poster for one of your favorite movies. If received by noon Eastern time on 2020-09-04, he will then add some bonus credit to your class participation grade.
