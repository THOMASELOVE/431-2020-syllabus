...
When available, https://github.com/THOMASELOVE/431-2020 will include links to:
...
- The course instructor is Professor Thomas E. Love. [More on him here][Professor Love]. 
- We also have several [teaching assistants][Teaching Assistants] helping with the course.
- The course is given on Tuesdays and Thursdays from 1:00 to 2:15 PM Eastern Time, via Zoom, starting on 2020-08-25.

## Getting Help {-}

Prior to the start of the class, to get help for anything related to the course, email **Thomas dot Love at case dot edu**.

Once the course begins, you have several ways to get help from us:

### Piazza is our discussion board {-}

- We will use **Piazza** this semester to facilitate questions and answers. We'll be conducting all class-related discussion there this term, rather than via email. 
- You'll need to sign up for our class at 
- Find our class page at: https://piazza.com/case/fall2020/pqhs431/home. If you're registered for the class, you should be able to sign up quickly.
...
- TA office hours will be held via Zoom, beginning 2020-08-31. A schedule will be available soon.
- In addition, Professor Love will open Zoom 15 minutes before and keep it open for at least 15 minutes after class to address any student concerns. 
    + If you have any special concerns about the course, need special accommodations or have any other issues you need to discuss with Professor Love, please email him.

Data science and statistical programming can be difficult. Computers are stupid and little errors in your code can cause hours of headache (even if you've been doing this stuff for years!). There are many, many online resources to help you with this, in addition to [our discussion board at Piazza](https://piazza.com/case/fall2020/pqhs431/home). 

- An especially useful one is the [RStudio Community](https://community.rstudio.com/) (a forum specifically designed for people using RStudio and the tidyverse (i.e. you)).
...
3. Visit [the Texts page](texts.html) to learn about the books you'll need to purchase and download.
...
7. Watch your CWRU email on August 24 for further bulletins (including the Zoom link for the first class session.)
