...
- The main instructor for the course is Professor Thomas E. Love. He uses he/him pronouns. [More on him here][Professor Love]. Most of my students call him Professor Love or Dr. Love.
- In this effort, he is assisted by several teaching assistants. [Details on the Teaching Assistants here][Teaching Assistants].
...
Data science and statistical programming can be difficult. Computers are stupid and little errors in your code can cause hours of headache (even if you've been doing this stuff for years!). There are many, many online resources to help you with this, in addition to XXXXXXXXemailing us at `431-help at case dot edu`XXXXX. An especially useful one is the [RStudio Community](https://community.rstudio.com/) (a forum specifically designed for people using RStudio and the tidyverse (i.e. you)).
