...
R is free, but it can sometimes be a pain to install and configure. Information about getting R and RStudio on your computer will be found below in the [Getting the Software][Getting the Software] section of this Syllabus.
...
- plus up to 50 additional points for Minute Paper responses (5 points for each on-time submission)
